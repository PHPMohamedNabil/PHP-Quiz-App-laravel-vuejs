    		...
    		<div class="module">
    		  ...
    		  <div class="module-body">
    		  	...
    		  	<div class="controls">
    		  		...
    		  		<textarea name="description" class="span8 @error('description') border-red @enderror" placeholder="description of a quiz">{{$quiz->description}}</textarea>
    		  			@error('description')
                           <span class="invalid-feedback" role="alert">
                  	           <strong>{{ $message }}</strong>
                           </span>
    		  	...
    		  	<div class="controls">
    		  		...
    		  		<input type="number" name="minutes" class="span8 @error('minutes') border-red @enderror" placeholder="name of a quiz" value="{{$quiz->minutes}}" min="1" />
    		  			@error('minutes')
                           <span class="invalid-feedback" role="alert">
                  	           <strong>{{ $message }}</strong>
                           </span>
